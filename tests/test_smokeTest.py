...
class TestSmokeTest():
  ...
  def test_smokeTest(self):
    ...
    self.driver.set_window_size(1601, 1127)
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Abel")
    self.driver.find_element(By.NAME, "lname").send_keys("Aguilar")
    self.driver.find_element(By.NAME, "bizname").send_keys("fds")
    ...
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("fgdfg")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("dfgdfg")
